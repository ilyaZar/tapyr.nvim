...
assert(golex_lines[4] == "Golex apps", "Golex app selection section is missing")
assert(golex_lines[6] == "No Golex apps in this shelf", "empty Golex shelf state changed")
assert(golex_lines[8] == "Add new Golex app", "Golex creation section is missing")
assert(golex_lines[10] == "new Golex app name > ", "Golex editable row changed")
assert(vim.api.nvim_win_get_cursor(0)[1] == 10, "Golex input row was not selected")
